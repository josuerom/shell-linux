...
alias autorpc='python3 ~/workspace/automations/GenerateContestRPC_Linux.py'
alias autocf='python3 ~/workspace/automations/GenerateContestCF_Linux.py'
...
alias runcpp='clear && compile_and_run() { g++ -std=c++17 -Wall -pedantic -DDEBUG -DLOCAL $1 -o ~/workspace/bin/exe.out && time ~/workspace/bin/exe.out; }; compile_and_run'
