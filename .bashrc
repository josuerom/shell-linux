...
alias runjava='compile_and_run() { java -d ~/workspace/bin $1.java && java -cp ~/workspace/bin $1; }; compile_and_run'
alias runcpp='compile_and_run() { g++ $1 -o ~/workspace/bin/exe.out -std=c++17 -Wall -pedantic -DDEBUG -DLOCAL && ~/workspace/bin/exe.out; }; compile_and_run'
